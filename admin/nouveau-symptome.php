...
<?php    
    ...
    if ($valid) {
            ...
            $sql = "INSERT INTO `symptomes` ( `IDMedecin`,`symptome`, `infosymptome`,`specialite`) 
            VALUES ('$idmedecin','$symptome','$infosymptome','$specialite')";
            $q = $pdo->prepare($sql);
            $q->execute(array($idmedecin, $symptome, $infosymptome, $specialite));
  ...
  <div class="panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-footer"><a href="authentification.php"> <span class="glyphicon glyphicon-log-out" aria-hidden="true"> </span>Déconnexion</a></div>
        ...
        <form id="form" action ="nouveau-symptome.php" method="post"> 
        <table> 
        <tr>
...
?>
       ...
       <tr>
        ...
        <td> <input type="text" class="form-control" id="symptome" placeholder="Nom Symptome" name="symptome"> </td>
       </tr>
     <tr>
         <tr>
        <td> <label> Informations symptome </label> </td>
        <td> <textarea class="form-control" name="infosymptome" id ="infosymptome" rows="4" cols="50"></textarea>
        </td>
       </tr>
