...
$specialite =$_POST['specialite'];
   ...
   if ($valid) {
            ...
            $sql = "INSERT INTO `medecin` (`Email`, `Nom`, `Prenom`, `Adresse`, `Numtlf`, `Prix`, `specialite`, `ville`) 
            VALUES ('$email', '$nom', '$prenom', '$adresse', '$numtlf', '$prix', '$specialite', '$ville')";
            $q = $pdo->prepare($sql);
            $q->execute(array($email, $nom, $prenom, $adresse, $numtlf, $prix, $specialite, $ville));
  ...
  <div class="panel-default">
    ...
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-footer"><a href="authentification.php"> <span class="glyphicon glyphicon-log-out" aria-hidden="true"> </span>Déconnexion</a></div>
        ...
        <form id="form" action="nouveau-medecin.php" method="post">
        <table>
        <tr>
     ...
     <tr> 
        ...
        <td> <input type="number" class="form-control" id="Numtlf" name="Numtlf" placeholder="Numero de telephone" required></td>
        </tr>
       <tr>
    ...
    <tr> 
    <td> <input type="text" class="form-control" id="Nom" name ="Nom" placeholder="Nom" required> </td>
    <td> <input type="number" class="form-control" id="Prix" name="Prix" placeholder="Prix de Consultation" required> </td> 
    </tr>
     <tr>
    ...
    <tr> 
    <td> <input type="text" class="form-control" id="Prenom" name="Prenom" placeholder="Prenom"required> </td>
    <td> <select class="form-control" id="specialite" name="specialite" required>
    <option> </option>
          <?php
...
?>
    ...
    <tr> 
        <td>  <input type="text" class="form-control" id="Adresse" name="Adresse" placeholder="Adresse" required> </td>
