...
<body>
 ...
 <?php
                   ...
                   foreach ($pdo->query($sql) as $row) {
                           ...
                           echo '<td width=200>';
                                echo '<a class="btn btn-success" href="update-specialite.php?id='.$row['ID'].'">Modifier</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="delete-specialite.php?id='.$row['ID'].'">Supprimer</a>';
                                echo '</td>';
                   }
                   Database::disconnect();
                  ?>
